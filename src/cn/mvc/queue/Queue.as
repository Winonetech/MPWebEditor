package cn.mvc.queue
{
	...
	import cn.mvc.events.QueueEvent;
	import cn.mvc.core.Command;
	import cn.mvc.collections.Holder;
	import cn.mvc.states.QueueIdleState;
	import cn.mvc.states.QueueInitializeState;
	import cn.mvc.states.QueueRunningState;
	import cn.mvc.utils.DebugUtil;
	...
	[Event(name="queueEnd"  , type="cn.mvc.events.QueueEvent")]
	...
	[Event(name="queueStart", type="cn.mvc.events.QueueEvent")]
	...
	[Event(name="stepEnd"   , type="cn.mvc.events.QueueEvent")]
	...
	[Event(name="stepStart" , type="cn.mvc.events.QueueEvent")]
	
	
	public class Queue extends MCEventDispatcher
	{
